...
void Dial::on_pb_ajouter_clicked()
{
...
void Dial::on_btn_image_clicked()
{
    Detenu D2;
...
void Dial::on_pb_rech_det_clicked()
{
    Detenu D2;
...
void Dial::on_pb_exportpdf_d_clicked()
{
    QString strStream;
...
void Dial::on_pb_supprimer_clicked()
{
    Detenu D1;
...
void Dial::on_pb_modifier_clicked()
{
    QString photo="";
...
void Dial::on_pb_ajouter_c_clicked()
{
...
void Dial::on_pb_rech_cel_clicked()
{
    Cellule C1;
...
void Dial::on_pb_export_c_clicked()
{
    QString strStream;
                   QTextStream out(&strStream);
                   QString strTitle = "Planning";
...
void Dial::on_pb_supprimer_c_clicked()
{
    Cellule C1;
...
void Dial::on_modif_cel_clicked()
{
...
void Dial::on_pushButton_RetourMenu_clicked()
{
    this->hide();
    Admin Admin;
    Admin.setModal(true);
