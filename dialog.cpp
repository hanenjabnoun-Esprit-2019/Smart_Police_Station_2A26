...
void Dialog::on_pb_ajout_clicked()
{
...
void Dialog::on_pb_dossiersup_clicked()
{
...
void Dialog::on_pb_ajout2_clicked()
{
...
void Dialog::on_pb_sup2_clicked()
{
...
void Dialog::on_pb_mod2_clicked()
{
...
void Dialog::on_pb_recherched_clicked()
{
...
void Dialog::on_pushButton_RetourMenu_clicked()
{
    this->hide();
    Admin Admin;
    Admin.setModal(true);
