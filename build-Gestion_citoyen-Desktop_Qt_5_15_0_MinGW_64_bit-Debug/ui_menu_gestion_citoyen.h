/********************************************************************************
** Form generated from reading UI file 'menu_gestion_citoyen.ui'
**
...
#ifndef UI_MENU_GESTION_CITOYEN_H
...
public:
    ...
    {
        if (Menu_gestion_citoyen->objectName().isEmpty())
            Menu_gestion_citoyen->setObjectName(QString::fromUtf8("Menu_gestion_citoyen"));
        Menu_gestion_citoyen->resize(920, 580);
        Menu_gestion_citoyen->setStyleSheet(QString::fromUtf8("\n"
"\n"
"QWidget\n"
"{\n"
"    color: #b1b1b1;\n"
...
"}\n"
""));
        groupBox = new QGroupBox(Menu_gestion_citoyen);
        ...
        QMetaObject::connectSlotsByName(Menu_gestion_citoyen);
    } // setupUi

    void retranslateUi(QDialog *Menu_gestion_citoyen)
    {
        Menu_gestion_citoyen->setWindowTitle(QCoreApplication::translate("Menu_gestion_citoyen", "Gestion citoyen", nullptr));
...
namespace Ui {
    class Menu_gestion_citoyen: public Ui_Menu_gestion_citoyen {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MENU_GESTION_CITOYEN_H
