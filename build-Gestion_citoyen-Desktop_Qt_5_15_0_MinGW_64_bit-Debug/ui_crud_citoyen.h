/********************************************************************************
** Form generated from reading UI file 'crud_citoyen.ui'
**
...
public:
    ...
    QPushButton *pb_mofidier;
    QWidget *tab_4;
    QLineEdit *le_numero_sup;
    QLabel *label_4;
    QPushButton *pushButton;
    QPushButton *pushButton_RetourMenuGestionCit;

    void setupUi(QDialog *Crud_citoyen)
    {
        if (Crud_citoyen->objectName().isEmpty())
            Crud_citoyen->setObjectName(QString::fromUtf8("Crud_citoyen"));
        Crud_citoyen->resize(920, 580);
        Crud_citoyen->setStyleSheet(QString::fromUtf8("\n"
"\n"
"QWidget\n"
"{\n"
"    color: #b1b1b1;\n"
...
""));
        ...
        label_5->setGeometry(QRect(70, 50, 91, 51));
        label_6 = new QLabel(tab_3);
        label_6->setObjectName(QString::fromUtf8("label_6"));
        label_6->setGeometry(QRect(80, 180, 81, 51));
        label_7 = new QLabel(tab_3);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(76, 322, 71, 61));
        Le_numero = new QLineEdit(tab_3);
        Le_numero->setObjectName(QString::fromUtf8("Le_numero"));
        Le_numero->setGeometry(QRect(260, 70, 113, 20));
        le_nom_2 = new QLineEdit(tab_3);
        le_nom_2->setObjectName(QString::fromUtf8("le_nom_2"));
        le_nom_2->setGeometry(QRect(260, 190, 113, 20));
        le_prenom_2 = new QLineEdit(tab_3);
        le_prenom_2->setObjectName(QString::fromUtf8("le_prenom_2"));
        le_prenom_2->setGeometry(QRect(260, 340, 113, 20));
        ...
        le_numero_sup = new QLineEdit(tab_4);
        le_numero_sup->setObjectName(QString::fromUtf8("le_numero_sup"));
        le_numero_sup->setGeometry(QRect(250, 100, 113, 20));
        label_4 = new QLabel(tab_4);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(40, 90, 71, 31));
    ...
    void retranslateUi(QDialog *Crud_citoyen)
    {
        Crud_citoyen->setWindowTitle(QCoreApplication::translate("Crud_citoyen", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("Crud_citoyen", "Ajout", nullptr));
...
namespace Ui {
    class Crud_citoyen: public Ui_Crud_citoyen {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CRUD_CITOYEN_H
