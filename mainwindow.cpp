...
void MainWindow::on_modif_cel_clicked()
{
...
void MainWindow::on_pb_rech_det_clicked()
{
    Detenu D2;
...
void MainWindow::on_pb_exportpdf_d_clicked()
{
    QString strStream;
...
void MainWindow::on_pb_export_c_clicked()
{
    QString strStream;
               QTextStream out(&strStream);
               QString strTitle = "Planning";
...
void MainWindow::on_pb_rech_cel_clicked()
{
    Cellule C1;
