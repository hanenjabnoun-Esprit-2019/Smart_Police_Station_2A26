...
void Dialog22::on_pb_ajouter_clicked()
{
...
void Dialog22::on_pb_search_eq_clicked()
{
    Equipement E1;
...
void Dialog22::on_pb_exportpdf_eq_clicked()
{
    QString strStream;
...
void Dialog22::on_pb_supprimer_clicked()
{
    Equipement E1;
...
void Dialog22::on_pb_modifier_e_clicked()
{
...
void Dialog22::on_pb_ajouter_v_clicked()
{
...
void Dialog22::on_pb_search_v_clicked()
{
    Vehicule V1;
...
void Dialog22::on_pb_exportpdf_v_clicked()
{
    QString strStream;
    QTextStream out(&strStream);
    QString strTitle = "Planning";
...
void Dialog22::on_pb_supprimer_v_clicked()
{
    Vehicule V1;
...
void Dialog22::on_pb_modifier_e_2_clicked()
{
    QString marq="",mod="";
...
void Dialog22::on_pushButton_RetourMenu_clicked()
{
   this->close();
    emit PageAccueil();
}
